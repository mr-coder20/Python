...
if num=="2":
    ...
    def weather(city):
        city = city.replace(" ", "+")
        res = requests.get('https://www.google.com/search?q={city}&oq={city}&aqs=chrome.0.35i39l2j0l4j46j69i60.6128j1j7&sourceid=chrome&ie=UTF-8', headers=headers)
        print("Searching...\n")
...
if num=="6":
    clear_console()
    ip =requests.get('https://api64.ipify.org?format=json').content.decode('utf8')   
